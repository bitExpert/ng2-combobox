...
2. Fork the repository (http://github.com/bitExpert/ng2-combobox)
3. Clone the canonical repository locally and enter it.

```console
$ git clone git://github.com:bitExpert/ng2-combobox.git
$ cd ng2-combobox
```
...
```console
$ git remote add {username} git@github.com:{username}/ng2-combobox.git
$ git fetch {username}
```

### Keeping Up-to-Date

Periodically, you should update your fork or personal repository to match the canonical ng2-combobox repository.
